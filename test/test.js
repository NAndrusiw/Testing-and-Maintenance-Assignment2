...
describe('purchaseOrder.js', function () {
  ...
  //getAgeFactor DCT
  describe('getAgeFactor function Behaviorial Test Task 3', function () {
  ...
  //getBalanceFactor DCT
  describe('getBalanceFactor function Behaviorial Test Task 3', function () {
    describe('Equivalence Class Tests', function () {
  ...
  //accountStatus DCT
  describe('accountStatus function Behaviorial Test Task 3', function () {
    describe('Equivalence Class Tests', function () {
  ...
  //creditStatus DCT
  describe('creditStatus function Behaviorial Test Task 3', function () {
    describe('Equivalence Class Tests', function () {
  ...
  //productStatus DCT
  describe('productStatus function Behaviorial Test Task 3', function () {
    describe('Equivalence Class Tests', function () {
  ...
  //orderHandling DCT
  describe('orderHandling function Behaviorial Test Task 3', function () {
    describe('Equivalence Class Tests', function () {
